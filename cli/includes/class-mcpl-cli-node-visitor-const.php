...
if ( ! class_exists( 'MCPL_CLI_Node_Visitor_Const' ) ) {
	class MCPL_CLI_Node_Visitor_Const extends NodeVisitorAbstract implements MCPL_CLI_Node_Visitor {
		...
		private function extract_from_node( Node $node ): void {
			if (
				...
				$this->tokens[] = new MCPL_CLI_Token_Const(
					new MCPL_CLI_Token(

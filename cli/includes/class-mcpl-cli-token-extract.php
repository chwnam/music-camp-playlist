...
if ( ! class_exists( 'MCPL_CLI_Token_Extract' ) ) {
	class MCPL_CLI_Token_Extract {
		private Parser $parser;

		/** @var Node[]|null $nodes */
		private array|null $nodes;

		private MCPL_CLI_Node_Visitor $visitor;

		private NodeTraverser $traverser;

		public function __construct( MCPL_CLI_Node_Visitor $visitor ) {

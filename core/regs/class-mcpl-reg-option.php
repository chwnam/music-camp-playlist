 ...
 *
 * regs/class-mcpl-reg-option.php
 */
...
if ( ! class_exists( 'MCPL_Reg_Option' ) ) {
	/**
	 ...
	 */
	class MCPL_Reg_Option implements MCPL_Reg {
		...
		public static function factory( string $option_name ): ?MCPL_Reg_Option {
			...
			if ( isset( $wp_registered_settings[ $option_name ] ) ) {
				if ( ! isset( static::$options[ $option_name ] ) ) {
					...
					static::$options[ $option_name ] = new MCPL_Reg_Option( $args['group'], $option_name, $args );
				}

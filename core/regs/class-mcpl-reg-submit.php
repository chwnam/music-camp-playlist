 ...
 *
 * regs/class-mcpl-reg-submit.php
 */
...
if ( ! class_exists( 'MCPL_Reg_Submit' ) ) {
	class MCPL_Reg_Submit implements MCPL_Reg {
		/**
		 * Constructor method
		 *
		 ...
		 * @param int|null             $priority     Priority number. Defaults to MCPL_PRIORITY.
		 */
		public function __construct(
			...
			$this->priority = is_null( $priority ) ? mcpl_priority() : $priority;
		}

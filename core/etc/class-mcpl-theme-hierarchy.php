 ...
 *
 * etc/class-mcpl-theme-hierarchy.php
 */
...
if ( ! class_exists( 'MCPL_Theme_Hierarchy' ) ) {
	final class MCPL_Theme_Hierarchy {
		...
		/** @var MCPL_Front_Module|string|false|null */
		private $front_module = null;

		private static ?MCPL_Theme_Hierarchy $instance = null;

		/**
		 * Get the instance.
		 *
		 * @return MCPL_Theme_Hierarchy
		 */
		public static function get_instance(): MCPL_Theme_Hierarchy {
		...
		private function __construct() {
			...
			do_action_ref_array( 'mcpl_theme_hierarchy', [ &$this ] );
		}

		/**
		 * Get front module.
		 *
		 * @return MCPL_Front_Module|string|null
		 */
		 ...
		 * Set front module.
		 *
		 * @param MCPL_Front_Module|string $module Front module instance, or class name
		 *
		 * @return void
		 */
		public function set_front_module( $module ) {
			if ( is_string( $module ) ) {
				$instance = mcpl_parse_module( $module );
				if ( $instance ) {
		...
		public function get_fallback(): MCPL_Front_Fallback {
			return new MCPL_Front_Fallback();
		}
